...
public class EditAccActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPreferences = new UserPreferences(EditAccActivity.this);
        ...
        Glide.with(EditAccActivity.this)
                .load(user.getImage())
                .centerCrop()
        ...
        ivGambar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LayoutInflater layoutInflater = LayoutInflater.from(EditAccActivity.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == GALLERY_PICTURE) {
            ...
            try {
                ...
                Toast.makeText(EditAccActivity.this, e.getMessage(),
        ...
        call.enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call,
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(EditAccActivity.this,
